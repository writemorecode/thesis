...
In this article, we describe a number of different algorithms for solving this optimization problem.
...
In @results_section, we present the our algorithm evaluation data.
