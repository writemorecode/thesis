...
of ``total_cost``, and aggregates summary statistics. Designed for quick CLI use:
    ...
    python scripts/analysis.py --results-dir eval_results
    python scripts/analysis.py --schedulers ffd,ruin_recreate
    python scripts/analysis.py eval_ffd.csv eval_ruin_recreate.csv
"""
